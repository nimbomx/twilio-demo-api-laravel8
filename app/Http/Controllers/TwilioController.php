...
class TwilioController extends Controller
{
    public function callme(Request $request)
    {
        ...
        $ACCOUNT_SID    = $config->twilio_account_sid ?: env('TWILIO_ACCOUNT_SID');
        $AUTH_TOKEN  =  $config->twilio_auth_token ?:  env('TWILIO_AUTH_TOKEN');
        $TWILIO_NUMBER =  $config->twilio_number ?:  env('TWILIO_NUMBER');
